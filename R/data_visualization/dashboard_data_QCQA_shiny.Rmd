...
runtime: shiny
resource_files:
- diurnal_composite_moving_window_rad.R
- read_database.R
---
...
```{r}
scatter_plot_QCQA(data,vars_temp[1],vars_temp[2],"HMP Air temperature (°C)","Sonic Temperature (°C)",0)
```

### RH HMP vs. RH 7200

```{r}
scatter_plot_QCQA(data,vars_RH[1],vars_RH[2], "HMP RH (%)","LI-7500 RH (%)",0)
```
...
```{r}
scatter_plot_QCQA(data,vars_pressure[1],vars_pressure[2], "Biomet PA (kPa)","EC PA (kPa)",0)
```
