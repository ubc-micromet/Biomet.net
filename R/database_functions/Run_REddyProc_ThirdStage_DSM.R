...
#   "C:\Program Files\R\R-4.2.1\bin\Rscript.exe" "C:\Biomet.net\R\database_functions\Run_REddyProc_ThirdStage_DSM.R" DSM 2022 "p:\database" "C:\Biomet.net\R\database_functions"  2> "p:\database\Calculation_procedures\TraceAnalysis_ini\DSM\log\DSM_ThirdStageCleaning.log" 1>&2
