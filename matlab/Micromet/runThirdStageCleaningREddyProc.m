...
%
    ...
    pthBatchFile = fullfile(pthBatch,[siteID '_ThirdStageCleaning.bat']);
    pthCleaningScript = fullfile(pthBiometR,['Run_REddyProc_ThirdStage_' siteID '.R']);
    pthLogFile = fullfile(pthBatch,[siteID '_ThirdStageCleaning.log']);
    ...
    if fidLog > 0    
        ...
        fprintf(fidLog,'Elapsed time: %6.1f seconds\n',toc);
        fprintf(fidLog,'=============================================\n'); 
        fclose(fidLog);
    end
