try
    ...
    years = yearNow-1:yearNow;          %  last year and this year
    ...
    for currentYear = years
        ...
        if fid> 0
            ...
            fprintf(fid,'Date/Time,Ta (degC),RH (%s), precipitation (mm), global_radiation_main (W), Tsoil_10 (degC), Tsoil_20 (degC), Tsoil_40 (degC),wind_speed (m/s), wind_direction (deg)  \n','%');
