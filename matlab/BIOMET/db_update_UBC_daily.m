...
if ~exist('Sites','var') | isempty(Sites)
   Sites     = {'BS'   'PA'   'YF'       'SQT'      'SQM'      'LGR1'     'LGR1_UPPER'  'LGR2'};
   Site_name = {'PAOB' 'PAOA' 'YF'       'SQT'      'SQM'      'LGR1'     'LGR1'        'LGR2'};
   Site_eddy = {'Eddy' 'Eddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy' 'MainEddy'    'MainEddy'};
end
...
for i = 1:length(Sites)
   ...
   switch upper(SiteId)
       case {'OY'}
           wc = ['*s.h' SiteId '.mat'];
       case {'HDF11' 'HJP02' 'HJP75' 'SQT' 'SQM' 'LGR1' 'LGR2'}
           wc = ['*.h' SiteId '.mat'];
       case {'LGR1_UPPER'}
           wc = ['*.h' 'SonicCal' '.mat'];
       case {'BS'}
