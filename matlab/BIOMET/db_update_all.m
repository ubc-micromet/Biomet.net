...
%     diarylog.m (it returns control to diarylog file after executing
%     every eval_wrapper call.
% Jul 9, 2020 (Pat)
%   - Added LGR1_UPPER site
% Apr 24, 2020 (Zoran)
%   - removed PA and BS from auto processing
% Jul 14, 2018 (Zoran)
%   - added LGR2
...
try
    ...
    % default inputs
    arg_default('runCleaning',1)
    arg_default('local_export',0);
    ...
    eval_wrapper('Updating hhour datebase (runing db_hhour_copy.m)', 'db_hhour_copy');
    ...
    if runCleaning == 1
        ...
        if local_export % do daily export to our local copy of the FCRN db (for internal use only)
            ...
            sites = {'YF' 'UBC_TOTEM' 'MPB1'}; 
                                            ...
                                            % removed HP11 Jul 14, 2018
                                            % removed PA, BS Apr 24, 2020
