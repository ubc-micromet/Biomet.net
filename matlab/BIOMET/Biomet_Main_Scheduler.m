...
[status,result] = system('robocopy D:\Sites\Picarro_AGGP\DataLog_User        "T:\Research_Groups\Sean_Smukler\SALdata\GHGdata\SAL Picarro All Data\UBC Farm Continous Data" /MOVE /E /NDL /NFL "');
fprintf(fid,'%s\n',result);
[status,result] = system('"rmdir D:\Sites\Picarro_AGGP\DataLog_User /S/Q "');
fprintf(fid,'%s\n',result);
[status,result] = system('robocopy D:\Sites\Picarro_AGGP\UBC_folder\csi_net  "T:\Research_Groups\Sean_Smukler\SALdata\GHGdata\SAL Picarro All Data\met-data\csi_net"                  /E /NDL /NFL         "');
fprintf(fid,'%s\n',result);
[status,result] = system('robocopy D:\Sites\Picarro_AGGP\UBC_folder          "T:\Research_Groups\Sean_Smukler\SALdata\GHGdata\SAL Picarro All Data\UBC Farm Continous Data\UBC_folder"  /MOVE /E /NDL /NFL "');
fprintf(fid,'%s\n',result);
