function db_NT_climate_stations(stationName,siteID,yearIn)
...
for dataYear = yearIn
    ...
    dbPath = fullfile(biomet_database_default,'yyyy','PROVINCIAL','NT','Met',stationName); % changed to be in same location as ECCC (directly in Database/yyyy)
