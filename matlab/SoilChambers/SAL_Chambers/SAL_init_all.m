...
% Last modification:         20230829 (Zoran)
% 
%
% Revisions:
%
%
    ...
    configIn.analyzer      = 'PICARRO';    % main gas analyzer
    ...
    %-----------------------
    configIn.Instrument(nPICARRO).varName    = configIn.analyzer;
    ...
    %-----------------------
    configIn.Instrument(nCH_CTRL).varName    = configIn.ch_ctrl;
...
function configIn = get_traces(configIn,dateIn)
    ...
    for i=1:configIn.chNbr
        configIn.chamber(i).traces = { ...
            'h2o_ppm',          'analyzer', 'PICARRO' ,        'H2O',   [10000 0];...
            'co2_dry',          'analyzer', 'PICARRO' ,    'CO2_dry',   [    1 0];...
            'ch4_dry',          'analyzer', 'PICARRO' ,    'CH4_dry',   [    1 0];...
            'n2o_dry',          'analyzer', 'PICARRO' ,    'N2O_dry',   [    1 0];...
            'pressureInlet',            [],         [],           [],          [];...
            'pressureOutlet',           [],         [],           [],          [];...
            'PAR_in',                   [],         [],           [],          [];...
...
%  This is the syntax in case that individual chambers have 
%  their own individual parameters that cannot be set by 
%  the loop above:
%
...
%         {
%         'PAR_in',                [],                 [],          [];...        
%         'soilTemperature_in',   'logger',   'MET_30min',  'Ts_1_AVG';...
%         'soilVWC_in',           'logger',   'MET_30min',  'VWC_1_AVG';...
%         }
%         ];
...
%
% NOTES: 
%   Chamber Number field needs to be called chamberNumber!
%   Had to manually rename ChNum to chamberNumber and '101' and '102' to 'tableID'
%

    configIn.varNames.tableID_101 = {'tableID','Year_RTM','Day_RTM','Hour_Minute_RTM','Seconds_RTM',...
            'chamberNumber','Tc_1','Tc_2','Tc_3','Tc_4','Tc_5','Tc_6',...
