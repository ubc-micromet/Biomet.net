...
%( pth, startDateIn,endDateIn, trace_name, trace_legend, trace_units, y_axis, fig_num,coeff,offset )
    ...
    for traceNum=1:N
        if LOAD_DATA == 1 
            ...
            try
                ...
                outputMatrix   = [outputMatrix plotY(indTimeGMT)];                 % extract the requested period
                outputDateTime = [outputDateTime tvIn];
                [plotY,indx] = del_num(plotY(indTimeGMT),0,0); % remove leading zeros from tmp
