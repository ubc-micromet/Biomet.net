...
x = plt_msig( [cumsum(x1)], ind, trace_name, [], year, trace_units, y_axis, tx_new, fig_num,[2.54]);
...
try
    ...
    xlabel('DOY')
    h = gca;
    set(h,'XLim',[st ed+1]); %,'YLim',[15000 40000])
...
% trace_path  = char(fullfile(pthEC,'Instrument_2.Avg_5'),fullfile(pthFl,'Sdiag_Avg'));
...
x = plt_msig( [cumsum(x1)], ind, trace_name, [], year, trace_units, y_axis, tx, fig_num,[2.54]);
if pause_flag == 1;pause;end
