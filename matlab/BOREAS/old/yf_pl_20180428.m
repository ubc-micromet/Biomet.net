...
if year>=2017
    Net_cnr1_AVG = read_bor('\\annex001.landfood.ubc.ca\database\2018\YF\Climate\YF_CR1000_1_MET_30\MET_CNR1_Net_Avg');
    S_upper_AVG = read_bor('\\annex001.landfood.ubc.ca\database\2018\YF\Climate\YF_CR1000_1_MET_30\MET_CNR1_SWi_Avg');
    S_lower_AVG = read_bor('\\annex001.landfood.ubc.ca\database\2018\YF\Climate\YF_CR1000_1_MET_30\MET_CNR1_SWo_Avg');
    L_upper_AVG = read_bor('\\annex001.landfood.ubc.ca\database\2018\YF\Climate\YF_CR1000_1_MET_30\MET_CNR1_LWo_Avg');
    L_lower_AVG = read_bor('\\annex001.landfood.ubc.ca\database\2018\YF\Climate\YF_CR1000_1_MET_30\MET_CNR1_LWi_Avg');
...
trace_name  = 'Climate: 31m H2O Concentration (LI-7500)';
    trace_path  = str2mat(fullfile(pth,'YF_CR1000_1_MET_30','IRGA_H2O_Avg'));
    trace_legend = str2mat('avg');
    trace_units = '(mmol/m3)';
    y_axis      = [100 1000];
    fig_num = fig_num + fig_num_inc;
