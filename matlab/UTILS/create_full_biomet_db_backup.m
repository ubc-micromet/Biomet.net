...
% File created: June 6, 2008 (Nick)         Last revision: Apr 3, 2018
% 
% Revisions:
%
% Apr 3, 2018 (Zoran)
%   - changed the reference path  to point to 20180403
% Mar 24, 2018 (Zoran)
%   - Added LGR1/2 backups
% Feb 2, 2017 (Zoran)
...
dv=datevec(now);
arg_default('sites',{'CR' 'HDF11' 'YF' 'OY' 'BS' 'PA' 'JP' 'HJP02' 'HJP75' 'MPB1' 'MPB2' 'MPB3' 'HP09' 'HP11' 'LGR1' 'LGR2'});
...
for m=1:length(sites)
    ...
    All_Sites     = {'BS'   'CR' 'HDF11'  'HJP02' 'HJP75' 'JP'   'OY' 'PA'   'YF' 'MPB1' 'MPB2' 'MPB3' 'HP09' 'HP11' 'LGR1' 'LGR2'};
    All_Site_name = {'PAOB' 'CR' 'HDF11'  'HJP02' 'HJP75' 'PAOJ' 'OY' 'PAOA' 'YF' 'MPB1' 'MPB2' 'MPB3' 'HP09' 'HP11' 'LGR1' 'LGR2'};
