function [EngUnits,Header,dataOut] = fr_read_TOA5(dateIn,configIn,instrumentNum)
...
%   Header      - file header
%   dataOut     - output structure containing all variables
%
%
...
%
% Jan 22, 2020 (Zoran)
%   - added output data structure dataOut
% 
% Sept 11, 2014 (Nick)
...
%   Changed to explicity round the end of the half-hour--works now! 
    ...
    [EngUnits,Header,tv,dataOut] = fr_read_TOA5_file(fileName);
