function [numOfFilesProcessed,numOfDataPointsProcessed] = fr_site_met_database(wildCardPath,chanInd,chanNames,tableID,processProgressListPath,databasePath,fileType,time_shift,timeUnit,structPrefix,missingPointValue,default_Csi_name,tv_input_format)
