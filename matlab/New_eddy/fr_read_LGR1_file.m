...
%
% Jan 30, 2019 (Zoran)
%   - Fixed data structure (varName = LGR) bugs.  The function would work only if varName is LGR.
%   - Used try-catch around *.mat saving instruction to prevent the program
%   from crashing if it cannot write the HF data in MAT format.  It prints
%   a warning instead.
